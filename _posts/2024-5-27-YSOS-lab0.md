...
根据仓库提供的.toml文件指定的Rust工具链，在项目根目录下运行make
...
校验文件完整性： 
![](/images/UEFI_check.png)

使用QEMU启动UEFI Shell： 
![](/images/UEFI_shell_open.png)

## YSOS

YSOS启动： 
![](/images/YSOS_running.png)
