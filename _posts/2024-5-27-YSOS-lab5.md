...
fork: ![](./image6/result_1.png){width="60%"}

counter: ![](./image6/result_2.png){width="60%"}

mq: ![](./image6/result_3.png){width="60%"}

dinner: ![](./image6/result_4.png){width="60%"}
...
![](./image6/fish_correct.png){width="80%"}

但事实上呢？有很小的概率会产出错误结果。

![](./image6/fish_wrong.png){width="80%"}
